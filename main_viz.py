...
def main(args):
    ...
    if configuration['save_dataset'] == True: # ! To save the specific dataset for later
    ...
    if(configuration['get_representations']):
        ...
        #samples = get_samples(dataset, configuration['num_representations'], idcs=args.idcs, random_ids=random_samples)
    ...
    #print(f'SAMPLES SHAPE: {samples.shape}') # num_samples x 1 x 32 x 32
